...
//#define LV_DEF_REFR_PERIOD  10   // 100 FPS（超流畅，性能强才能用）
//#define LV_DEF_REFR_PERIOD  15   // 66 FPS  （最推荐！流畅不卡）
//#define LV_DEF_REFR_PERIOD  20   // 50 FPS  （平衡流畅）
#define LV_DEF_REFR_PERIOD  33   // 30 FPS  （默认，有点卡）
...
#define LV_GRADIENT_MAX_STOPS   4       //渐变点数
...
#define LV_USE_ANIMIMG    1   /* 超强流畅度： 播放图片序列 */
...
#define LV_USE_LOTTIE     1   /* 高端 UI 质感： Lottie (JSON) 动画 */
...
#if LV_USE_FS_WIN32
    #define LV_FS_WIN32_LETTER 'B'     /**< Set an upper-case driver-identifier letter for this driver (e.g. 'A'). */
    #define LV_FS_WIN32_PATH "F:\\A_ZZT_Project\\Xiaoya_Xiyiji\\LVGL_zzt_v1.2\\lv_port_pc_vscode-master\\image"         /**< Set the working directory. File/directory paths will be appended to it. */
...
/** BMP decoder library 对CPU要求非常低，但需要大内存*/
#define LV_USE_BMP 1
...
#if LV_USE_TINY_TTF
    /* Disable file-path font loading to keep UI font pipeline MCU-portable */
...
#define LV_USE_SYSMON   1
    ...
    #define LV_USE_PERF_MONITOR 1    //帧率监控
...
/** 1: Enable an observer pattern implementation 打开观察者模式*/
